...
Pod::Spec.new do |s|
  ...
  s.description  = "Here you can find some class extension which i created in my projects."
  ...
  # Or just: s.author    = "Andrea"
  # s.authors            = { "Andrea" => "Bellotto" }
  # s.social_media_url   = "http://twitter.com/Andrea"
